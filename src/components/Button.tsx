...
function Button({ children,type, onClick,primary,done,deletes,reload,themeSwitch,login}: ButtonProps) {
	...
	if (primary) {
		...
		classes = "flex text-[1.6251rem] hover:scale-110 duration-200 text-black font-bold rounded-full bg-emerald-500/90 dark:bg-emerald-500/70 hover:bg-emerald-600 dark:hover:bg-emerald-700 p-[4px] text-slate-200";
	} else if (deletes) {
		classes = "flex  text-3xl hover:scale-110 duration-200 text-black font-bold rounded-full  bg-rose-500/90 dark:bg-rose-500/70 hover:bg-rose-600 dark:hover:bg-rose-700 text-slate-200 p-[2px]";
	} 
	else if (reload) {
