...
const Button: React.FC<ButtonProps> = ({
	...
	if (primary) {
		...
		classes =
			"p-2.5 text-2xl rounded-full border-2 bg-gray-200 hover:bg-gray-300 dark:hover:bg-gray-700 dark:bg-gray-800 border-gray-700 dark:border-slate-400 text-gray-700 dark:text-slate-400 duration-200 relative z-50 active:rotate-[360deg]";
	} else if (downBtn) {
		classes =
