...
function NewTaskForm({onSubmit,taskNameRef,dateRef}:NewTaskFormProps) {
  ...
  return (
    <form onSubmit={onSubmit} className="bg-gray-800 mx-2 py-2 px-2 xs:px-6 md:py-4 md:px-12 rounded-2xl mx-auto flex flex-row gap-3  sm:gap-5 md:gap-12 xs:max-w-md sm:max-w-xl md:max-w-4xl shadow-md mb-0 z-10 justify-evenly items-center">
