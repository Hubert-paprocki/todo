...
function Task({
	...
	if (isTaskOverdue(taskDeadline)) {
		...
		new Date(taskDeadline).toDateString() === new Date().toDateString()
	) {
		...
		<li className={classes}>
			{isUpdating ? (
				<>
					...
					<p className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-700 dark:from-violet-400 to-rose-700 dark:to-cyan-400 uppercase tracking-wide text-lg sm:text-xl px-3 col-start-2 justify-self-center md:col-span-1 md:row-span-3 flex items-center">
						{taskName}
					</p>
				...
				<>
					...
					<p className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 dark:from-violet-400 to-rose-600 dark:to-cyan-400 uppercase tracking-wide text-lg sm:text-xl px-3 col-start-2 justify-self-center md:col-span-1 md:row-span-3 flex items-center font-semibold">
						{taskName}
					</p>
