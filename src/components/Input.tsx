...
function Input({type,refs,required,date,placeholder}:InputProps) {
	...
	return (
<div className=" p-0.5 rounded-3xl max-w-sm bg-gradient-to-r from-indigo-700 to-rose-700 dark:from-violet-500 dark:to-cyan-500 self-center"><input className={classes} type={type} ref={refs} required placeholder={placeholder} defaultValue={date ? formattedCurrentDate : undefined} /></div>
	);
}
