...
function Input({type,refs,required,date,placeholder}:InputProps) {
	...
	return (
<div className=" p-0.5 rounded-3xl max-w-sm bg-gradient-to-r from-violet-600 to-cyan-600"><input className={classes} type={type} ref={refs} required placeholder={placeholder} defaultValue={date ? formattedCurrentDate : undefined} /></div>
	);
}
