...
function Footer() {
  ...
  return (
    <div className='bg-zinc-900 text-neutral-300 text-md xs:text-lg px-5 xs:px-10 flex flex-col pt-0 md:pt-5 justify-center items-center md:items-stretch text-center shadow-top gap-y-10 md:flex-row md:gap-y-0'>
