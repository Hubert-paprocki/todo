...
function Welcome({username}:WelcomeProps) {
  return (
    <div className="text-center mx-auto p-10 pb-12 font-roboto text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-xl text-white uppercase tracking-wide z-10">
