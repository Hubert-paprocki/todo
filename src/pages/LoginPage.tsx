        ...
        <div className="bg-gray-200 dark:bg-gray-800  sm:m-4 py-3 px-6 md:py-6 md:px-12 rounded-2xl max-w-3xl shadow-xl relative  duration-150">
          <div className="gap-5 sm:gap-8  text-center">
            <div className="flex justify-between md:items-center pb-6">
              <LanguageSwitch />
              <h1 className="font-bold capitalize text-2xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-rose-600 dark:from-violet-400 dark:to-cyan-400 tracking-wider block">
                Hi there!
              </h1>
              <ThemeSwitch />
            </div>
            <p className="border-b-2 mb-5 sm:mb-8 md:mb-10 pb-4 border-gray-400 dark:border-slate-600">
              ...
              we can remember your tasks across sessions. Please provide us with
              your name or nickname in the reply to this message. Once we have
